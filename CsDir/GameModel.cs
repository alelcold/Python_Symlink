...
public class GameModel
{
    ...
    private int[,] mMap = new int[kMaxColumns, kMaxRows];
    ...
    public bool IsShapePositionValid(int[][] shapeVector2)
    {
        ...
        //         //地图边界Get ShapeVector2邊界
                
        //         // if (IsInsideMap(shapeVector2) == false)
        //         // {
        //         //     return false;
        //         // }
        //         // //其它shape
    ...
    {
        //map and data
        mMap = new int[kMaxColumns, kMaxRows];
